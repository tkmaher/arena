    ...
    return (
        ...
        >
            ...
            <p className="info-text">
                ...
                With these rules in mind, arena-flow.org uses <a target="_blank" href="https://en.wikipedia.org/wiki/Adjacency_list">adjacency lists</a> to construct directed graphs based on the relationship between blocks, channels, users, and groups.
            </p>
            <p className="info-text">
