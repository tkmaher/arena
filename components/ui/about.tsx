    ...
    return (
        ...
        >
            ...
            <p className="info-text">
                ...
                With these rules in mind, neighborhoods.na uses <a target="_blank" href="https://en.wikipedia.org/wiki/Adjacency_list">adjacency lists</a> to construct directed graphs based on the relationship between blocks and channels.
            </p>
            <p className="info-text">
